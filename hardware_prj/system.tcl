...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_GPIO_EMIO_GPIO_ENABLE {0} CONFIG.PCW_GPIO_MIO_GPIO_ENABLE {1} CONFIG.PCW_IMPORT_BOARD_PRESET {C:/Chery/IMF/ZYBO_zynq_def.xml} CONFIG.PCW_QSPI_GRP_SINGLE_SS_ENABLE {1} CONFIG.PCW_UART0_PERIPHERAL_ENABLE {1}  ] $processing_system7_0
