proc getPresetInfo {} {
  return [dict create name {ps} description {ps}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {ps} ]
}
...
return [dict create \
    ...
    CONFIG.PCW_IMPORT_BOARD_PRESET {C:/Chery/IMF/ZYBO_zynq_def.xml}  \
